 ...
 * @author omara
 */
public class ProductReturn extends ProductWindow {

    /**
     * Creates new form ProductReturn
     */
    ...
    protected void button1ActionPerformed(java.awt.event.ActionEvent evt)
    {
        ...
        {JOptionPane.showMessageDialog(null, "The customer with SSN = " + super.customerSSN + " should be paid a return price for teh return product");
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductReturn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProductReturn().setVisible(true);
            }
        });
    }
