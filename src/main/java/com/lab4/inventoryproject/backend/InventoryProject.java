...
public class InventoryProject {
    ...
    public void testAdminRole() {
        ...
        Record[] employees = admin.getListOfEmployees();
        for (Record emp : employees) {
    ...
    public void testEmployeeRole() {
        ...
        if(returnValue != ((Product) newProducts[oldProducts.length+3]).getPrice()){
    ...
    public static void main(String[] args) {
        InventoryProject test = new InventoryProject();
        test.testAdminRole();
        System.out.println("---------------------------------------------------\n---------------------------------------------------");
